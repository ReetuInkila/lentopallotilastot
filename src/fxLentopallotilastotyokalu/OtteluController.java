...
/// Tästä eteenpäin ei suoraan käyttöliittymään liittyvää koodia
    ...
    /**
     * Tilaston tallentamiseen käytettävät muuttujat
     */
    private int pId;
    ...
    private void tallennaTilasto() throws SailoException { 
        try {
            ...
            if (vastustaja.equals("") || paiva.equals("") || suorite.equals("")) Dialogs.showMessageDialog("Tarkista vastustaja, päivä ja suorite!");
    ...
    /**
     * Avataan varmistus ikkuna viimeisimmän tilaston poistamiselle ja siirrytään tilaston poistamiseen jos poistaminen valittu
     */
